                                ...
                                foreach ($wphrmUsers as $key => $userdata) {
                                    ...
                                    if (isset($wphrmEmployeeInfo['wphrm_employee_status']) && $wphrmEmployeeInfo['wphrm_employee_status'] == 'Active') {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if (isset($getattendanceby_id) && $getattendanceby_id->status == 'absent') { ?>
                                                    ...
                                                    <input type="text" class="form-control" style="<?php echo esc_attr($style); ?>" id="reason<?php echo esc_attr($userdata->ID); ?>" name="reason[<?php echo esc_attr($userdata->ID); ?>]" placeholder="<?php _e('Absent Reason', 'wphrm'); ?>" value="<?php
                                                    if (isset($getattendanceby_id->reason)) : echo esc_attr($getattendanceby_id->reason);
                                                    endif;
                                                    ?>">
                                                       <?php } else { ?>
                                                    ...
                                                    <input type="text" class="form-control reason" style="<?php echo esc_attr($style); ?>" id="reason<?php echo esc_attr($userdata->ID); ?>" name="reason[<?php echo esc_attr($userdata->ID); ?>]" placeholder="Absent Reason" value="<?php
                                                    if (isset($getattendanceby_id->reason)) : echo esc_attr($getattendanceby_id->reason);
                                                    endif;
                                                    ?>">
                                                       <?php } ?>   
