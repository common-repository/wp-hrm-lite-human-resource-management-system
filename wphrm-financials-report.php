            ...
            <div class="portlet box blue calendar">
                <div class="portlet-title">
                  ...
                  <div class="actions">
                     ...
                     <a href="javascript:;"   data-loading-text="Updating..."  class="demo-loading-btn btn btn-sm red">
                      ...
                      <div class="customTooltip-wrap" >
                     <a href="javascript:;"   data-loading-text="Updating..."  class="demo-loading-btn btn btn-sm yellow">
                ...
                <div class="portlet-body">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="wphrmDataTable">
                        ...
                        <tbody>
                            <?php
                            $i=1;
                            $wphrm_finacials = $wpdb->get_results("SELECT * FROM  $this->WphrmFinancialsTable");
